...
public class Fornecedor_Suprimento_Teste {
	...
	public static void main(String[] args) throws SQLException {
		...
		Fornecedor fornecedor = new Fornecedor(2, "forne2", "1235.356.326/589", null, "3333-2325", "forne2@gmail.com.br");
		Suprimento suprimento = new Suprimento(2, "Frango", null, 50, 1.05d, null, null);
		...
		//forneSupriServi.excluir(3);
		
		//listando fornecedor_suprimento
