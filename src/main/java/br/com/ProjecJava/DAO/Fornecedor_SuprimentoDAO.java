...
public class Fornecedor_SuprimentoDAO {
	...
	public List<Fornecedor_Suprimento> listarForneSupri() throws SQLException {
		...
		String sql = "SELECT * FROM FORNECEDOR_SUPRIMENTOS"
				+ "LEFT JOIN FORNECEDOR ON FORNECEDOR_SUPRIMENTOS.FOR_SUP_FORNECEDOR_COD = FORNECEDOR.FOR_COD"
				+ "LEFT JOIN SUPRIMENTO ON FORNECEDOR_SUPRIMENTOS.FOR_SUP_SUPRIMENTO_COD = SUPRIMENTO.SUPRI_COD"
				+ "LEFT JOIN MARCA ON SUPRIMENTO.SUPRI_MARCA_COD = MARCA.MARCA_COD";
